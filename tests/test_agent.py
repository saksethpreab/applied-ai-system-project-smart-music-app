...
class TestAnalyzePrompt:
    ...
    def test_valid_prompt_returns_all_keys(self, mock_client):
        ...
        prefs, reasoning, confidence = analyze_prompt("chill studying music", mock_client)
    ...
    def test_floats_are_in_range(self, mock_client):
        ...
        prefs, _, _ = analyze_prompt("any prompt", mock_client)
    ...
    def test_json_retry_succeeds(self, mock_client):
        ...
        prefs, reasoning, confidence = analyze_prompt("any prompt", mock_client)
    ...
    def test_double_json_failure_returns_fallback(self, mock_client):
        ...
        prefs, _, confidence = analyze_prompt("???", mock_client)
